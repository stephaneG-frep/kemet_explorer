...
const pharaohsData = [
  ...
  Pharaoh(
    ...
    role: 'Roi des premières dynasties',
    facts: [
      'Règne vers la fin du IIIe millénaire av. J.-C.',
      'Souverain attesté par des inscriptions royales anciennes.',
      'Participe à la consolidation de l’État dynastique primitif.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Semerkhet',
  ),
  Pharaoh(
    id: 'nynetjer',
    name: 'Nynetjer',
    era: 'IIe dynastie',
    role: 'Roi de l’époque thinite',
    facts: [
      'Règne au début du IIIe millénaire av. J.-C.',
      'Connu par plusieurs inscriptions administratives.',
      'Figure importante des dynasties archaïques.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Nynetjer',
  ),
  Pharaoh(
    id: 'khasekhemwy',
    name: 'Khâsekhemoui',
    ...
    role: 'Roi de réunification',
    facts: [
      'Dernier roi de la IIe dynastie.',
      'Souvent lié au rétablissement de l’unité du royaume.',
      'Prépare le contexte de la IIIe dynastie.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Khasekhemwy',
  ),
  Pharaoh(
    id: 'sahure',
    name: 'Sahourê',
    era: 'Ancien Empire',
    role: 'Roi de la Ve dynastie',
    facts: [
      'Règne vers le XXVe siècle av. J.-C.',
      'Connu pour ses reliefs et expéditions maritimes.',
      'Important pour l’essor des cultes solaires.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Sahure',
  ),
  Pharaoh(
    id: 'neferirkare',
    name: 'Néferirkarê Kakaï',
    era: 'Ancien Empire',
    role: 'Roi de la Ve dynastie',
    facts: [
      'Règne vers le XXVe siècle av. J.-C.',
      'Développe l’administration royale.',
      'Figure importante de la dynastie des cultes de Rê.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Neferirkare_Kakai',
  ),
  Pharaoh(
    id: 'amenemhat2',
    name: 'Amenemhat II',
    ...
    role: 'Roi de la XIIe dynastie',
    facts: [
      'Règne vers 1929-1895 av. J.-C.',
      'Consolide les réseaux diplomatiques et commerciaux.',
      'Poursuit la stabilité institutionnelle du Moyen Empire.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Amenemhat_II',
  ),
  Pharaoh(
    id: 'senousret2',
    name: 'Sésostris II',
    ...
    role: 'Roi de la XIIe dynastie',
    facts: [
      'Règne vers 1897-1878 av. J.-C.',
      'Associé à l’aménagement du Fayoum.',
      'Période de continuité administrative et agricole.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Senusret_II',
  ),
  Pharaoh(
    id: 'neferhotep1',
    name: 'Néferhotep Ier',
    era: 'Deuxième Période intermédiaire',
    role: 'Roi de la XIIIe dynastie',
    facts: [
      'Règne au XVIIe siècle av. J.-C.',
      'Souverain marquant de la XIIIe dynastie.',
      'Montre la persistance d’un pouvoir royal malgré la fragmentation.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Neferhotep_I',
  ),
  Pharaoh(
    id: 'amenhotep2',
    name: 'Amenhotep II',
    ...
    role: 'Roi de la XVIIIe dynastie',
    facts: [
      'Règne vers 1427-1401 av. J.-C.',
      'Poursuit la politique impériale au Levant.',
      'Connu pour son image de roi guerrier.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Amenhotep_II',
  ),
  Pharaoh(
    id: 'thoutmosis4',
    name: 'Thoutmôsis IV',
    ...
    role: 'Roi de la XVIIIe dynastie',
    facts: [
      'Règne vers 1401-1391 av. J.-C.',
      'Connu pour la “stèle du songe” du Sphinx.',
      'Maintient les équilibres diplomatiques du Nouvel Empire.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Thutmose_IV',
  ),
  Pharaoh(
    id: 'psousennes2',
    name: 'Psousennès II',
    era: 'Troisième Période intermédiaire',
    role: 'Dernier roi de la XXIe dynastie',
    facts: [
      'Règne vers 967-943 av. J.-C.',
      'Marque la transition vers la XXIIe dynastie.',
      'Figure de charnière politique du premier millénaire av. J.-C.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Psusennes_II',
  ),
  Pharaoh(
    id: 'amyrtaeus',
    name: 'Amyrtée',
    era: 'Dynasties indépendantes tardives',
    role: 'Roi de la XXVIIIe dynastie',
    facts: [
      'Règne vers 404-398 av. J.-C.',
      'Dirige la brève XXVIIIe dynastie indépendante.',
      'Symbolise le retour temporaire d’un pouvoir indigène.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Amyrtaeus',
  ),
  Pharaoh(
    id: 'nectanebo_family',
    name: 'Takhos (Teos) et les Nectanébo',
    era: 'Dynasties indépendantes tardives',
    role: 'Rois de la XXXe dynastie',
    facts: [
      'Période de résistance à la pression perse.',
      'Dernier grand cycle de souverains égyptiens autochtones.',
      'Contexte militaire et diplomatique instable.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Thirtieth_Dynasty_of_Egypt',
  ),
  Pharaoh(
    id: 'ptolemee4',
    name: 'Ptolémée IV Philopator',
    era: 'Époque ptolémaïque',
    role: 'Roi lagide',
    facts: [
      'Règne de 221 à 204 av. J.-C.',
      'Période de tensions politiques internes.',
      'Règne charnière du déclin progressif lagide.',
    ],
    imagePath: 'assets/images/kemet_1.png',
    imageSourceUrl: 'https://en.wikipedia.org/wiki/Ptolemy_IV_Philopator',
  ),
];
